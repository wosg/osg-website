<div class="span4 portfolio-item nature people">
	<div class="picture"><a href="${url}" title="${title}"><r:img dir="images/osg/presentation" file="${imageFileName}" alt="${title}" class="rounded-corners" /><div class="image-overlay-link"></div></a>
