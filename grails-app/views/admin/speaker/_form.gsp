...
<div class="fieldcontain ${hasErrors(bean: speakerInstance, field: 'gitlabId', 'error')} ">
	<label for="gitlabId">
		<g:message code="speaker.githubId.label" default="Gitlab Id" />
	</label>
	<g:textField name="gitlabId" value="${speakerInstance?.gitlabId}" />
</div>
