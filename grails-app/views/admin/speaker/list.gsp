...
<div id="list-speaker" class="content scaffold-list" role="main">
	...
	<table>
		...
		<tr>
			...
			<g:sortableColumn property="gitlabId" title="${message(code: 'speaker.gitlabId.label', default: 'Gitlab Id')}" />
			...
			<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
				...
				<td>
					<g:if test="${speakerInstance?.gitlabId}">
						<a href="http://osggitlab.wipro.com/${speakerInstance?.gitlabId}">${speakerInstance?.gitlabId}</a>
					</g:if>
				</td>
