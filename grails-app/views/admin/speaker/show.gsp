	...
	<ol class="property-list speaker">
		...
		<g:if test="${speakerInstance?.githubId}">
			<li class="fieldcontain">
				...
				<g:if test="${speakerInstance?.gitlabId}">
			<li class="fieldcontain">
				<span id="gitlabId-label" class="property-label"><g:message code="speaker.gitlabId.label" default="Gitlab Id" /></span>

				<span class="property-value" aria-labelledby="gitlabId-label"><g:fieldValue bean="${speakerInstance}" field="gitlabId" /></span>
			</li>
		</g:if>
